/* 2 / 3 - Ultrapassando V
Desafio
Como um bom desenvolvedor, você precisa fazer um programa que leia dois inteiros: R e V 
(devem ser lidos tantos valores para V quantos necessários, até que seja digitado um valor maior do que R para ele). 
Conte quantos números inteiros devem ser somados em sequência (considerando o R nesta soma) 
para que a soma ultrapasse a V o mínimo possível. Escreva o valor final da contagem.

A entrada pode conter, por exemplo, os valores 21 21 15 30. 
Neste caso, é então assumido o valor 21 para R enquanto os valores 21 e 15 devem ser desconsiderados 
...
Exemplo de Entrada	Exemplo de Saída (3 + 4 + 5 + 6 + 7)
3
1                   5
20	  
*/
// a função gets é implementada dentro do sistema para ler as entradas(inputs) dos dados e 
// a função print para imprimir a saída (output) de dados.
// Abaixo segue um exemplo de código que você pode ou não utilizar


//let R = parseInt(gets());
const readline = require('readline-sync');
let R = parseInt(readline.question());
let V = 0;
